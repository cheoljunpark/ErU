...
def warp_image(img, source_prop):
    ...
    perspective_transform = cv2.getPerspectiveTransform(source_prop, destination_points)
...
class IMGParser:
    def __init__(self):
        ...
        '''
        # self.source_prop = np.float32([[280,200],[360,200],[640,350],[0,350]])
        self.source_prop = np.float32([[270,250],[370,250],[630,300],[10,300]])
